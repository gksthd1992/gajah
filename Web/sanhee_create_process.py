...
# cv2.imwrite('input.jpg',Contents2)
# Style2 = cv2.imread(StyleImage)
# cv2.imwrite('style.jpg',Style2)

Contents2 = cv2.resize(Contents2, dsize=(500, 600))
cv2.imwrite('ART123.jpg', Contents2)
# 화면에 결과 보여 줄때
# cv2.imshow('Final2.jpg', Contents2)

# 합성 코드 인풋 데이터 준비!!!
# Contents3 = cv2.imread('input.jpg')
# Style3 = cv2.imread('style.jpg')
# img1 = cv2.resize(Contents3, dsize=(300, 400))
# img2 = cv2.resize(Style3, dsize=(300, 400))
...
# 완성된 사진 저장
# cv2.imwrite('Final.jpg', Contents2)
...
<html lang="en">
  ...
  <body>
    ...
    <form action="a.html">
        <!--<button type="button" onclick="location.href='get_object_for_html.py' ">create objects</button>-->
    ...
    <form action="enter_number.py">
        <!-- 입력 받기 -->
          <p><input type = "text" name = "input_num" size="20" placeholder = "ex) myFace.jpg ...">
          <input type = "submit" ></p></br></br></br></br></br></br>

            <!-- 
            <input type="button" name="b1" value="제출" >
